...
class _TopRateState extends State<TopRate> {
  ...
  void ListPopular() async {
    ...
    final res = await http.get(
      Uri.parse(
          "https://api.themoviedb.org/3/movie/top_rated?api_key=ddd0961778774abbadc977169438bddf&language=en-US&page=1"),
    );
    print("status code " + res.statusCode.toString());
    topratee = toprate.fromJson(json.decode(res.body.toString()));
    setState(() {
      isloaded = true;
    });
  }
      ...
      body: Padding(
        ...
        child: Container(
          ...
          child: Center(
            child: isloaded == true
                ? ListView.builder(
                    itemCount: topratee!.results!.length,
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => Detailtop(
                                    results: topratee!.results![index])),
                          );
                        },
                        child: Card(
